...
namespace Buzea_Ana_Lab2.Data
{
    public class Buzea_Ana_Lab2Context : DbContext
    {
        ...
        public DbSet<Buzea_Ana_Lab2.Models.Category> Category { get; set; } = default!;
        public DbSet<Buzea_Ana_Lab2.Models.Member> Member { get; set; } = default!;
        public DbSet<Buzea_Ana_Lab2.Models.Borrowing> Borrowing { get; set; } = default!;
    }
}
